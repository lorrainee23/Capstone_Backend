      ...
      <div class="stats-dashboard">
        ...
        <div class="stats-grid">
          <div class="stat-card primary">
            ...
            <div class="stat-value">{{ formatNumber(quickStats.total_violations || 0) }}</div>
            <div class="stat-change positive" v-if="quickStats.violations_change > 0">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <polyline points="22,12 18,12 15,21 9,3 6,12 2,12"></polyline>
              </svg>
              +{{ quickStats.violations_change }}% from last period
            </div>
            <div class="stat-change negative" v-else-if="quickStats.violations_change < 0">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <polyline points="22,12 18,12 15,21 9,3 6,12 2,12"></polyline>
              </svg>
              {{ quickStats.violations_change }}% from last period
            </div>
            <div class="stat-change neutral" v-else>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <div class="stat-card success">
            ...
            <div class="stat-value">₱{{ formatCurrency(quickStats.total_revenue || 0) }}</div>
            <div class="stat-change positive" v-if="quickStats.revenue_change > 0">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <polyline points="22,12 18,12 15,21 9,3 6,12 2,12"></polyline>
              </svg>
              +{{ quickStats.revenue_change }}% from last period
            </div>
            <div class="stat-change negative" v-else-if="quickStats.revenue_change < 0">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <polyline points="22,12 18,12 15,21 9,3 6,12 2,12"></polyline>
              </svg>
              {{ quickStats.revenue_change }}% from last period
          ...
          <div class="stat-card warning">
            ...
            <div class="stat-value">₱{{ formatCurrency(quickStats.pending_amount || 0) }}</div>
            <div class="stat-subtitle">{{ quickStats.pending_count || 0 }} pending tickets</div>
          </div>
          ...
          <div class="stat-card info">
            ...
            <div class="stat-value">{{ quickStats.collection_rate || 0 }}%</div>
            <div class="progress-bar">
              <div class="progress-fill" :style="{ width: (quickStats.collection_rate || 0) + '%' }"></div>
            </div>
          </div>
        </div>
      </div>
